...
- [`StatusInstances`](classes/StatusInstances.md) — `cats.Monoid` and `cats.Eq` instances for
  [`Status`](../core/classes/Status.md), exposing the algebraic structure described in the `core` module as standard
  cats typeclasses.
